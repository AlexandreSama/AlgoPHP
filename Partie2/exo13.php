...
<body>
    ...
    <p>Créer  une  classe  Voiture  possédant  les  propriétés  suivantes: marque,  modèle,  nbPortes et vitesseActuelle ainsi que les méthodes 
        ...
        v1 ➔"Peugeot","408",5
        v2 ➔"Citroën","C4",3
        Coderl’ensemble des méthodes, accesseurs et mutateurs de la classe tout en réalisant des jeux de tests pour vérifier la cohérence de la classe Voiture.</p>

    <h2>Résultat</h2>

    <?php
        /* The above class is a PHP implementation of a car object with methods to set and get its
        properties such as brand, model, number of doors, current speed, and vehicle state. */
        class Voiture{
